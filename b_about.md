...
1. **Zhang H**, Wang HF, Teng XQ. A second-order, global-in-time energy stable implicit-explicit Runge--Kutta scheme for the phase field crystal equation[J]. SIAM Journal on Numerical Analysis, 2024, 62(6): 2667-2697. [[DOI: 10.1137/24M1637623](https://www.researchgate.net/publication/386407572){:target="_blank"}]
...
1. Teng X, **Zhang H**. High-order L2-bound-preserving Fourier pseudo-spectral schemes for the Allen-Cahn equation[J]. Numerical Algorithms, 2024: 1-36. [[DOI: 10.1007/s11075-024-01772-5](https://www.researchgate.net/publication/378127580){:target="_blank"}]
1. Liu L, **Zhang H**, Song S. Maximum-Principle-Preserving, Steady-State-Preserving and Large Time-Stepping High-Order Schemes for Scalar Hyperbolic Equations with Source Terms[J]. Communications in Computational Physics, 2024, 35(2): 498-523. [[DOI: 10.4208/cicp.OA-2023-0143](https://www.researchgate.net/publication/381069669){:target="_blank"}]
1. Liu L, **Zhang H**, Qian X, et al. High-order, large time-stepping integrators for scalar hyperbolic conservation laws[J]. Communications in Nonlinear Science and Numerical Simulation, 2024, 131: 107806. [[DOI: 10.1016/j.cnsns.2023.107806](https://www.researchgate.net/publication/376966880){:target="_blank"}]
1. Liu Z, **Zhang H**, Qian X, et al. Mass and energy conservative high-order diagonally implicit Runge–Kutta schemes for nonlinear Schrödinger equation[J]. Applied Mathematics Letters, 2024: 109055.  [[DOI: 10.1016/j.aml.2024.109055](https://www.researchgate.net/publication/378717221){:target="_blank"}]
1. **Zhang H**, Qian X, Xia J, Song S. Efficient inequality-preserving integrators for differential equations satisfying forward Euler conditions[J]. ESAIM: M2AN, 57 (2023) 1619–1655 [[DOI: 10.1051/m2an/2023029](https://www.researchgate.net/publication/369649110){:target="_blank"}]
1. **Zhang H**, Yan J, Qian X, Song S. Temporal high-order, unconditionally maximum-principle-preserving integrating factor multi-step methods for Allen-Cahn-type parabolic equations[J].Applied Numerical Mathematics, 2023, 186: 19-40. [[DOI: 10.1016/j.apnum.2022.12.020](https://www.researchgate.net/publication/366913499){:target="_blank"}]
1. **Zhang H**, Yan J, Qian X, Song S. Unconditionally maximum principle preserving parametric integrating factor two-step Runge-Kutta schemes for parabolic sine-Gordon equations. CSIAM Transactions on Applied Mathematics 4 (1) (2023) 177–22.  [[DOI: 10.4208/csiam-am.SO-2022-0019](https://www.researchgate.net/publication/367165633){:target="_blank"}]
1. Sun J, **Zhang H**, Qian X, et al. A family of structure-preserving exponential time differencing Runge–Kutta schemes for the viscous Cahn–Hilliard equation[J]. Journal of Computational Physics, 2023, 492: 112414. [[DOI: 10.1016/j.jcp.2023.112414](https://www.researchgate.net/publication/372993654){:target="_blank"}]
1. Qian X, **Zhang H**, Yan J, et al. Novel High-Order Mass-and Energy-Conservative Runge-Kutta Integrators for the Regularized Logarithmic Schrodinger Equation[J]. Numerical Mathematics-Theory Methods and Applications, 2023, 16(4): 993-1012.  [[DOI: 10.4208/nmtma.OA-2022-0185](https://www.researchgate.net/publication/375453592){:target="_blank"}]
1. Sun J, **Zhang H**, Qian X, et al. Up to eighth-order maximum-principle-preserving methods for the Allen–Cahn equation[J]. Numerical Algorithms, 2023, 92(2): 1041-1062. [[DOI: 10.1007/s11075-022-01329-4](https://www.researchgate.net/publication/361652254){:target="_blank"}]
1. Gao Z, **Zhang H**, Qian X, et al. High-order unconditionally maximum-principle-preserving parametric integrating factor Runge-Kutta schemes for the nonlocal Allen-Cahn equation[J]. Applied Numerical Mathematics, 2023, 194: 97-114. [[DOI: [10.1016/j.apnum.2023.08.010](https://doi.org/10.1016/j.apnum.2023.08.010)](https://www.researchgate.net/publication/373815868){:target="_blank"}]
1. Xu Qian, **Hong Zhang**, Jingye Yan, Songhe Song. Novel high-order mass-and energy-conservative Runge-Kutta integrators for the regularized logarithmic Schrödinger equation[J]. Numerical Mathematics Theory Methods and Applications, 2023,16(4):993-1012 [[DOI: [10.4208/nmtma.OA-2022-0185](https://doi.org/10.4208/nmtma.OA-2022-0185](https://www.researchgate.net/publication/375453592){:target="_blank"}]
1. Yang J, Yi N, **Zhang H**. High-order, unconditionally maximum-principle preserving finite element method for the Allen–Cahn equation[J]. Applied Numerical Mathematics, 2023, 188: 42-61.  [[DOI: 10.1016/j.apnum.2023.03.002](https://www.researchgate.net/publication/369217009){:target="_blank"}]
1. Yan X, Qian X, **Zhang H**, et al. Solving nonlinear delay-differential-algebraic equations with singular perturbation via block boundary value methods [J]. Journal of Computational Mathematics, 2023, 41(4). [[DOI: 10.4208/jcm.2109-m2021-0020](https://www.researchgate.net/publication/371208499){:target="_blank"}]
1. Huang Y, Peng G, Zhang G, **Zhang H**. High-order Runge–Kutta structure-preserving methods for the coupled nonlinear Schrödinger–KdV equations[J]. Mathematics and Computers in Simulation, 2023, 208: 603-618. [[DOI: 10.1016/j.matcom.2023.01.031](https://www.researchgate.net/publication/368226733){:target="_blank"}]
1. **Zhang H**, Yan J, Qian X, Song S. Up to fourth-order unconditionally structure-preserving parametric single-step methods for semilinear parabolic equations. Computational Methods in Applied Mathematics and Engineering, 393 (2022) 114817. [[DOI: 10.1016/j.cma.2022.114817](https://www.researchgate.net/publication/359729749){:target="_blank"}]
1. **Zhang H**, Yan J, Qian X, Chen X, Song S. Explicit third-order unconditionally structure-preserving schemes for conservative Allen-Cahn equations. Journal of Scientific Computing, 2022, 90(8):1-29  [[DOI: 10.1007/s10915-021-01691-w](https://www.researchgate.net/publication/356390111){:target="_blank"}]
1. Yan J, **Zhang H**, Qian X, et al. A novel regularized model for the logarithmic Klein-Gordon equation[J]. Applied Numerical Mathematics, 2022, 176: 19-37. [[DOI: 10.1016/j.apnum.2022.02.007](https://www.researchgate.net/publication/358791225){:target="_blank"}]
1. Yan XQ, Qian X, **Zhang H**, Song SH. Numerical approximation to nonlinear delay-differential–algebraic equations with proportional delay using block boundary value methods. Journal of Computational and Applied Mathematics, 2021, 404(1): 0-113867  [[DOI: ]10.1016/j.cam.2021.113867](https://www.researchgate.net/publication/355639705){:target="_blank"}]
1. Jingye Yan, Xu Qian, **Hong Zhang**, Songhe Song. Two regularized Energy preserving finite difference methods for the logarithmic Klein–Gordon equation. Journal of Computational and Applied Mathematics, 2021, 393:113478 [[DOI: 10.1016/j.cam.2021.113478](https://www.researchgate.net/publication/349501549){:target="_blank"}]
1. Jingye Yan, **Hong Zhang**, Xu Qian, Songhe Song. Regularized ﬁnite diﬀerence methods for the logarithmic Klein-Gordon equation[J]. East Asian Journal on Applied Mathematics, 2021, 11(1): 119-142 [[DOI: 10.4208/eajam.140820.250820](https://www.researchgate.net/publication/347974260){:target="_blank"}]
1. **Zhang H**, Yan J, Qian X, Gu X, Song S. On the maximum principle preserving and energy stability of high-order implicit-explicit Runge-Kutta schemes for the space-fractional Allen-Cahn equation. Numerical Algorithms, 2021, 88:1309-1336 [[DOI: 10.1007/s11075-021-01077-x](https://www.researchgate.net/publication/351064055){:target="_blank"}]
1. **Zhang H**, Yan J, Qian X, Song S. Numerical analysis and applications of explicit high order maximum principle preserving integrating factor Runge-Kutta schemes for Allen-Cahn equation [J]. Applied Numerical Mathematics, 2021, 161: 372-390. [[DOI: 10.1016/j.apnum.2020.11.022](https://www.researchgate.net/publication/347463394){:target="_blank"}]
1. **Hong Zhang**, Xu Qian, Jingye Yan, Songhe Song. Highly efficient invariant-conserving explicit Runge-Kutta schemes for nonlinear Hamiltonian diffierential equations[J]. Journal of Computational Physics, 2020, 418(4–5):109598, [[DOI: 10.1016/j.jcp.2020.109598](https://www.researchgate.net/publication/337195610_Highly_efficient_invariant-conserving_explicit_Runge-Kutta_schemes_for_the_nonlinear_Hamiltonian_differential_equations?_sg=HpuAU1zrdM2Zj3xJ5DMWattKtODkITk7oe3TKvh1HJphOAOoBpiKDBVuvE6hS3XkH7vNuIR-ARb6WLlsSeLLZHkZtSzJmcCoqjlK2jsx.jMQvPSsd6VRtOp7W0euFsj39hcPCPZfLm9R0g3n5ku6LdrKfIuwUMOKUdh5wuRH_pNYWvgyiINan-_H1RfRp4Q){:target="_blank"}]
...
1. Y.R. Guo, W.J. Yang, **H. Zhang**, J. Wang and S.H. Song. A splitting method for the Degasperis-Procesi equation using an optimized WENO scheme and the Fourier pseudospectral method [J], Advances in Applied Mathematics and Mechanics, 2019, 11: 53-71 [[DOI: 10.4208/aamm.OA-2018-0054](https://www.researchgate.net/publication/333535353){:target="_blank"}]
...
1. **Zhang H**, Zegeling P A. Simulation of thin film flows with a moving mesh mixed finite element method, Applied Mathematics and Computation, 2018, 338: 274-289. [[DOI: 10.1016/j.amc.2018.06.017](https://www.researchgate.net/publication/321918521_Simulation_of_thin_film_flows_with_a_moving_mesh_mixed_finite_element_method){:target="_blank"}]
